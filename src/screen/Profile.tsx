...
const Profile = () => {
    ...
    const [firstName, setFirstName] = useState(sessionStorage.getItem(CONSTANTS.FIRST_NAME))
    const [lastName, setLastName] = useState(sessionStorage.getItem(CONSTANTS.LAST_NAME))
    ...
    const handleProfileUpdate = async () => {
        ...
        try {
            await request.put(`${process.env.REACT_APP_KEYCLOAK_URL}` + UPDATE_PROFILE_URL + USER_ID, formBody)
                .then(() => {
