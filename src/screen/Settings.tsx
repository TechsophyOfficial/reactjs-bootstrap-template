...
const Settings = () => {
    ...
    const handleLanguageChange = (event) => {
        const [selectedLanguage] = selectLanguage.filter((item) => item.value === event.target.value)
        ...
        <div style={{ display: "flex", justifyContent: 'center', alignItems: 'center', paddingTop: "50px" }}>
            <Typography variant='h3'>
                <div style={{ display: "flex", alignItems: 'center', justifyItems: 'center' }}>
                    ...
                    <Select options={selectCountry} label={"           "} onChange={handleCountryChange} value={countryValue} />
                </div>
                <div style={{ display: "flex", justifyContent: 'center' }}>
                    ...
                    <Select options={selectLanguage} label={"           "} onChange={handleLanguageChange} value={languageValue} />
                </div>
            </Typography>
        </div>
    );
