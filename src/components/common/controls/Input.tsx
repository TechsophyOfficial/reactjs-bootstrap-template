...
import { FormControl, InputAdornment, makeStyles, MenuItem, Select, TextField } from '@material-ui/core';
import '../../../index.scss';
import Label from './Label';
import { CalendarToday, PhoneInTalkOutlined } from '@material-ui/icons';
...
const Input = (props) => {
    ...
    return (
        <div className={'form-control'}>
            {label && <Label title={label} required={required} inputLabelStyles={inputLabelStyles} />}
            {type === 'tel' && (
                <TextField
                    variant="outlined"
                    size={size}
                    ...
                    InputProps={{
                        startAdornment: (
                            <InputAdornment position="start" className={classes.phoneCodeWrap}>
                                <PhoneInTalkOutlined />
            ...
            {(type === 'text' || type === 'password' || !type || type === 'email') && (
                <TextField
                    variant="outlined"
                    size={size}
                    required={required}
