      ...
      <div style={{ width: "100%" }}>
              ...
              <div>
                <ol style={{ fontWeight: "bold" }}>
                  ...
                  <li>
                    ...
                    <ul style={{ fontWeight: "normal" }}>
                      <li><em>title</em> : pass the title value into this variable.</li>
                      <li>optional props:
                        <ul><li><em>inputLabelStyles</em> : custom style can be passed into this variable.</li>
                          <li>
                            <em>required/required={'{true}'}</em> : can be added in the label component in order to make it mandatory. (E.g. Label*)
                          </li></ul>
                      </li>
                    </ul>
                  </li>
              ...
              <div>
                <ol style={{ fontWeight: "bold" }}>
                  ...
                  <li>
                    Pass the props value -
                    <ul style={{ fontWeight: "normal" }}>
                      <li><em>type</em> : type of input field(text/number),</li>
                      <li><em>variant</em> : variant of input field,</li>
                      <li><em>size</em> : size of the field (small/medium),</li>
                      <li><em>rows</em> : number of rows (size) assigned for the input field</li>
                    </ul>
                  </li>
                </ol>
              </div>
        ...
        {itemIndexValue === 2 && (
          <>
            ...
            <ListItemPanel tabIndexValue={itemIndexValue} index={2}>
              <Button variant="text" color="black" text="Text Button" />
            </ListItemPanel>
            <ListItemPanel tabIndexValue={itemIndexValue} index={2}>
              <div>
                <ol style={{ fontWeight: "bold" }}>
                  ...
                  <li>
                    Pass the props value -
                    <ul style={{ fontWeight: "normal" }}>
                      <li><em>text</em> : title of the button,</li>
                      <li>
                        optional props:
                        <ul>
                          <li><em>size</em> : size of the button; standard size is large (E.g. Text Button)</li>
                          <li><em>variant</em> : variant of the button (outlined/text); standard is contained</li>
                          <li><em>color</em> : color of text in the button</li>
                        </ul>
                      </li>
                    </ul>
                  </li>
            ...
            <ListItemPanel tabIndexValue={itemIndexValue} index={3}>
              <div>
                <ol style={{ fontWeight: "bold" }}>
                  ...
                  <br />
                  <li>
                    Pass an array object into data variable. Object should contain
                    title and value.
                    <br />
                    Ex. -
                    <ul style={{ fontWeight: "normal" }}>
              ...
              <div>
                <ol style={{ fontWeight: "bold" }}>
                  <ul style={{ fontWeight: "normal" }}>
                    ...
                    interactive to the user. This can be set as checked/unchecked
                    based on the value from API.
                  </ul>
                  <li
                  >
                    First import the component by placing below line into your
                ...
                <ol style={{ fontWeight: "bold" }}>
                  ...
                  <li>
                    ...
                    <ul style={{ fontWeight: "normal" }}>
                      ...
                      <br />
                      <li><em>label</em> : title of the radio group,</li>
                      <li><em>value</em> : state needs to be passed in this variable for the selected radio option value in order to pass it to an API.</li>
                      <li><em>handleChange</em> : to change the state value</li>
                      <li><em>list</em> : contains the radio menu list</li>
                      <li>optional props:
                        <ul>
                          <li><em>required</em> : pass as true/false to make the field mandatory</li>
                          <li><em>row</em> : pass as false in order to display options in differeent rows</li>
                        </ul>
                      </li>
                    </ul>
                  </li>
              ...
              <div>
                <ol style={{ fontWeight: "bold" }}>
                  ...
                  <li>
                    ...
                    <br />
                    <ul style={{ fontWeight: "normal" }}>
                      <li>If state variable is true loader start running then
                        once it set to false it will stop.</li>
                      <li>Load spinner can be used between API call or component loading.</li>
                      <li>While initiating API call, the state can be set to true, and
                        later to false once data is fetched succesfully.</li>
                      <li>In the above representation when <em>Start Loader</em> button is clicked, the state is
                        set to true for 5 sec to loading the spinner. After 5 sec, it'll retain the false state dismissing the load spinner.</li>
                    </ul>
                  </li>
                </ol>
              </div>
              ...
              <div>
                <ol style={{ fontWeight: "bold" }}>
                  ...
                  <li>
                    ...
                    <ul style={{ fontWeight: "normal" }}>
                      <li>
                        <em>open</em> : state to open and close the date selector dialog.
                      </li>
                      <li>
                        <em>handleClose</em> : function to close the date selector.
                        <br />
                        E.g.
                        <em>
                          {
                      ...
                      <li>
                        <em>handleSubmit</em> : function to submit the selected date.
                        <br />
                        E.g.
                        <em>
                          {"  const handleCustDates = (fromDate, toDate) => {}"}
                      ...
                      <li>
                        In the above representation when <em>Select Date</em> button is clicked, the state is
                        set to true opening the date picker. Once Cancel/Submit is clicked, it'll call respective the function.
                      </li>
                    </ul>
                  </li>
                </ol>
              ...
              <div>
                <ol style={{ fontWeight: "bold" }}>
                  ...
                  <li>
                    ...
                    <br />
                    <ul style={{ fontWeight: "normal" }}>
                      <li>Below props value can be passed to the component:
                        ...
                        <ul style={{ paddingLeft: "15px" }}>
                          {"metaInfo?: MetaInfo;"} <br />{"name?: string;"} <br />{" id?: string;"} <br />
                        </ul>
                        {"}"}
                        <br />
                        <br />
                        These details can be used to set and pass the properties of the document.
                      </li>
                    </ul>
                  </li>
                </ol>
                  ...
                  <li>
                    ...
                    <ul style={{ fontWeight: "normal" }}>
                      <li>
                        ...
                        accordingly.
                        <ul style={{ fontWeight: "normal", paddingLeft: "55px" }}>
                          <li>
                            {"checked: boolean;"} boolean state variable.
                          </li>
                          <li>
                            {"onChange: (e) => void;"} to change state of the checked variable.
                          </li>
                          <li>
                            {"name?: string;"}
                          </li>
                          ...
                          <li>
                            {"labelStyle?: string;"} css className to style the label can be passed.
                          </li>
                          <li>{" disabled?: boolean;"} can be passed to disable toggle.</li>
                        </ul>
                      </li>
                    </ul>
                  </li>
                ...
                <div>
                  <ol style={{ fontWeight: "bold" }}>
                    ...
                    <li>
                      ...
                      <br />
                      <ul style={{ fontWeight: "normal" }}>
                        <li>isOpen - state variable used to control the popup open
                          and close.</li>
                        <li>
                          text - the text you want inside the popup modal.
                        </li>
                        <li>
                        ...
                        <li>
                          callBackModal - pass the handle close function to
                          update isOpen state to false to close the modal.
                        </li>
                      </ul>
                    </li>
                  </ol>
                  ...
                  <ol style={{ fontWeight: "bold" }}>
                    ...
                    <li>
                      ...
                      <ul style={{ fontWeight: "normal" }}>
                        ...
                        <li><em>options </em>: a list object like selectData is to be passed to options to be chosen from.</li>
                      </ul>
                    </li>
                  </ol>
                </div>
            ...
            <>
              ...
              <ListItemPanel tabIndexValue={itemIndexValue} index={13}>
                <div>
                  <ol style={{ fontWeight: "bold" }}>
                    <ul style={{ fontWeight: "normal" }}>
                      These checkboxes component are only for representation. It's not interactive to the user.
                    </ul>
                    <li
                    //  style={{ fontWeight: "bold" }}
                    >
                    ...
                    <li>
                      ...
                      <ul style={{ fontWeight: "normal" }}>
                        ...
                        <li>
                          <em>view </em>: circle can be passed as view. However, defult is square.
                        </li>
                      </ul>
                    </li>
                  </ol>
          ...
          itemIndexValue === 14 && (
            <>
              <ListItemPanel tabIndexValue={itemIndexValue} index={14}>
                <CheckboxList list={checkList} onChange={(e, list) => setCheckList(list)} />
              </ListItemPanel>
              <ListItemPanel tabIndexValue={itemIndexValue} index={14}>
                <div>
                  <ol style={{ fontWeight: "bold" }}>
                    ...
                    <li>
                      ...
                      <ul style={{ fontWeight: "normal" }}>
                        <li>
                          <em>checkboxListData </em>: an array of data objects with these four feilds:
                          <br />
                          <ul>
                            <li>title</li>
                            <li>value</li>
                        ...
                        <li><em>onChange</em> : to change state of the checked variable. </li>
                      </ul>
                    </li>
                  </ol>
                </div>
